    ...
    difference() {
        union() {
            ...
            translate([-overcut,-od/2,-overcut])
                cube([
                    support_thickness+overcut,
                    od,
                    hole_height + overcut + od/2
                ]);
        ...
        translate([
                support_thickness
                    + (od - fastener_notch_width)/tan(brace_angle)/2,
        ...
        translate([0, -od/2, hole_height + od/2])
            ...
            translate([
                -overcut,
                -sqrt(2)*adjusted_bevel/2,
                -sqrt(2)*adjusted_bevel/2
            ])
            cube([
                support_thickness + 2*overcut,
...
module edge_clip(
    ...
    difference() {
        ...
        translate([
            -overcut,
            -overcut,
            -edge_dz - lip_dz - bottom_dz - overcut
        ])
            cube([
                dx + 2 * overcut,
                undercut_dy + overcut,
        ...
        translate([0, dy, top_dz])
            ...
            translate([-overcut, -corner_cut*sqrt(2)/2, -corner_cut*sqrt(2)/2])
            cube([
                dx + overcut - mask_left_back_bevels,
                corner_cut*sqrt(2),
                corner_cut*sqrt(2)
            ]);
        ...
        // back lip cutout
        translate([
            corner_distance - edge_dy - lip_dy,
            -overcut,
            - edge_dz - lip_dz
        ])
...
module dummy_tee(expand=0, extend=0) {
    translate([siphon_offset_x, siphon_offset_y, siphon_offset_z])
        union() {
            ...
            rotate([180, 0, 0])
                cylinder(
                    h=pipe_od/2 + elbow_overlap + extend,
                    d=elbow_od + 2*expand
                );
            rotate([90, 0, 0])
                translate([0,0,-(pipe_od/2 + elbow_overlap + extend)])
                cylinder(
                    h=pipe_od + 2*elbow_overlap + 2*extend,
                    d=elbow_od + 2*expand
                );
...
module tee_shell(
    ...
    elbow_octogon_bevel_diameter = (
        elbow_od + 2*thickness - 2*bevel)/cos(180/8);
    pipe_octogon_bevel_diameter = (
        pipe_od + 2*thickness - 2*bevel)/cos(180/8);
        ...
        translate([siphon_offset_x, siphon_offset_y, siphon_offset_z])
            union() {
                ...
                rotate([90, 0, 0])
                    ...
                    union () {
                        cylinder(
                            h=pipe_od + 2*elbow_overlap - 2*bevel,
                            d=elbow_octogon_diameter,
                            $fn=8
                        );
                        ...
                        difference() {
                            ...
                            translate([
                                ...
                                rotate([0,0,45])
                                translate([
                                    -default_bevel*sqrt(2)/2,
                                    -(default_bevel+overcut)*sqrt(2)/2,
                                    - overcut
                                ])
                                cube([
                                    default_bevel*sqrt(2),
                                    (default_bevel + overcut)*sqrt(2),
                        ...
                        translate([
                            ...
                            fastener_block(
                                ...
                                od=2*thickness,
                                support_thickness=(
                                    elbow_octogon_side - 2*thickness)/2
                            );
                            rotate([0,0,180])
                                fastener_block(
                                    $fn=60,
                        ...
                        translate([
                            ...
                            rotate([-90,0,0])
                                fastener_block(
                                    ...
                                    od=2*thickness,
                                    support_thickness=(
                                        pipe_octogon_side - 2*thickness)/2
                                );
                            rotate([90,0,180])
                                fastener_block(
                                    $fn=60,
...
module right_edge_clip() {
    ...
    difference() {
        union() {
            ...
            translate([
                default_bevel,
                siphon_offset_y - default_thickness/2,
                default_thickness
            ])
                difference() {
                    // body of brace
                    cube([
                            iron_top_width + iron_top_side_indent_width
                                + default_thickness - default_bevel,
                            default_thickness,
                            iron_top_width + iron_top_side_indent_width
                                + default_thickness - default_bevel
                    ]);
                    ...
                    rotate([0,45,0])
                        ...
                        cube([
                            default_bevel*sqrt(2),
                            (default_bevel + overcut)*sqrt(2),
                            sqrt(2)*(iron_top_width + iron_top_side_indent_width
                                + default_thickness - default_bevel)
                                + 2*overcut
                        ]);
                }
        ...
        difference() {
            union() {
                ...
                translate([7,-10,0])
                    rotate([0,0,90])
                    fastener_block(
                        hole_height=default_thickness - default_bevel + 3.2,
                        $fn=60
                    );
            }
            translate([0, 0, 10])
        ...
        union() {
            ...
            difference() {
                ...
                translate([
                    ...
                    iron_top_width + iron_top_side_indent_width
                        + default_thickness,
                    -(iron_top_indent_thickness + iron_top_indent_depth
                        + default_thickness),
                ])
                    cube([
                        default_thickness,
                ...
                translate([
                    default_thickness,
                    iron_top_width + iron_top_side_indent_width
                        + default_thickness + right_plate_length,
                    -iron_top_indent_depth - iron_top_indent_thickness
                        - default_thickness
                ]) {
                    ...
                    rotate([0,0,45])
                        ...
                        cube([
                                ...
                                sqrt(2)*default_bevel,
                                iron_top_indent_depth
                                    + iron_top_indent_thickness
            ...
            translate([
                    siphon_offset_x - iron_top_width
                        - iron_top_side_indent_width - default_thickness,
                    siphon_offset_y - (pipe_od/2 + elbow_overlap - default_bevel
                        - default_thickness),
                    default_thickness
            ])
                difference() {
                    ...
                    // cut off left side of top of support (to avoid left tee
                    // shell)
                    translate([
                        0,
                        -default_thickness/2 - overcut,
                    ...
                    // cut off back left side of top of support (to avoid left
                    // tee shell)
                    translate([
                        0,
                        default_thickness - overcut,
                        0
                    ])
                        cube([
                            10*sqrt(2),
...
mirror(show_left_bracket ? [1,0,0] : [0,0,0]) {
    if (print_plate) {
        // right edge clip
        translate([-100,50,0])
            rotate([0,90,0])
        ...
        aquarium_intake_clamp(explode=10);
    }
}
